...
const Add = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      console.error("Error uploading project:", error); // Log the error to the console
      toast.error("Error uploading project"); // Optionally display a user-friendly message
    }
  };
