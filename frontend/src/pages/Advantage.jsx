...
const Advantage = () => {
  ...
  const dropdownData = [
    ...
    },
    {
      title: "2. ACOUSTICS",
      content: [
        `AEROLITE METALWORKS COMES WITH DIFFERENT PERFORATION PATTERNS TO MEET ACOUSTIC ENVIRONMENT OF DESIRED SPACE.
  THUS AEROLITE METALWORKS ARE PERFECT FOR ADJUSTING THE ACOUSTICS IN AREAS COVERED BY THE CEILING BY USING TILES WITH PERFORATION, OR IN COMBINATION WITH PLAIN, STD PERFORATED, MICROPERFORATED DESIGN TILES. IT IS ESSENTIAL TO DEFINE THE ACOUSTICS REQUIREMENT EARLY IN THE DESIGN STAGE. THE FOLLOWING SHOULD BE CONSIDERED I.E., THE APPLIED BUILDING MATERIALS, SURFACES WITHIN THE ROOM, VOLUME OF THE ROOM, SOFT FURNISHING AND FINALLY THE PROPOSED USE OF THE ROOM.`,
        `THERE ARE TWO ASPECTS OF ACOUSTICS: THE SOUND ABSORPTION PERFORMANCE OF THE TILE WHICH DEALS WITH THE REDUCTION OF SOUND EMANATING FROM WITHIN THE ROOM, AND MEASURED AS THE NOISE REDUCTION COEFFICIENT (NRC) (FROM 0.1 TO 0.7) AND SOUND ATTENUATION (STA) WHICH DEALS WITH THE TRANSMISSION OF SOUND BETWEEN ADJACENT AREAS AND MEASURED IN DECIBELS (DB).`,
      ],
      image: acoustic,
    },
    {
    ...
    },
    {
      ...
      content: [
        "AEROLITE METAL CEILINGS AND LIGHT WEIGHT CALCIUM SILICATE INHERENTLY INORGANIC MATERIALS AND ARE IMMUNE TO TERMITE ATTACK.",
      ],
      image: terminate,
    },
  ];
          ...
          <div className=" bg-white relative">
            <div className="bg-white bg-opacity-75 p-6 rounded-md shadow-lg text-left">
              <h1 className=" text-lg">
                AEROLITE METALWORKS IS THE INDIA’S PREMIUM CUSTOMIZED METAL
